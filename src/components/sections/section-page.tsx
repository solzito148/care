  ...
  return (
    <section className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <h2 className="text-lg font-semibold text-slate-900">Proxima iteracion</h2>
          <p className="mt-2 text-sm text-slate-600">
            Este modulo ya esta preparado para agregar funcionalidades reales con componentes
        ...
        <Card>
          ...
          <p className="mt-2 text-sm text-slate-600">
            Se mantienen jerarquias claras, contrastes altos y tipografias legibles para personas
